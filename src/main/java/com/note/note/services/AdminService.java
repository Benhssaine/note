...
import com.note.note.repositories.AdminRepository;
...
public class AdminService implements IAdmin {
    ...
    @Override
    public Admin addNewAdmin(String firstName, String lastName, LocalDate dob, String phone, String secretCode, String password, String confirmPassword) {
        if(adminRepository.findBySecretCode(secretCode) != null)
            return null;
        if(! password.equals(confirmPassword))
            return null;
        Admin newAdmin = adminRepository.save(new Admin(firstName, lastName, dob, phone, secretCode, passwordEncoder.encode(password)));
    ...
    public Boolean addRoleToAdmin(String secretCode, String roleName) {
        Admin admin = adminRepository.findBySecretCode(secretCode);
    ...
    public Admin loadAdminBySecretCode(String secretCode) {
        return adminRepository.findBySecretCode(secretCode);
    }
}
